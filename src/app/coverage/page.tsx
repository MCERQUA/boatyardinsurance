    ...
    <>
      ...
      <section className="py-16 lg:py-24 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Types of Marine Businesses We Insure
            </h2>
            <p className="text-lg text-muted-foreground">
              We provide specialized coverage for all types of boat yards and marine facilities.
            </p>
          </div>

          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {siteConfig.businessTypes.map((business) => (
              <Card key={business.name} className="text-center hover:shadow-lg transition-shadow">
                <CardContent className="pt-6">
                  ...
                  <p className="text-xs text-muted-foreground/70">{business.specs}</p>
                </CardContent>
              </Card>
            ))}
          </div>
          ...
          <div className="text-center mt-8">
            <p className="text-muted-foreground">
              Have a different type of marine facility? We likely cover it too.{" "}
